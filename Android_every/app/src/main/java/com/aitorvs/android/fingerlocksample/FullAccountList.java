...
public class FullAccountList extends AccountsList {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (i1 == R.id.change_master_password) {
            if (Utilities.isSyncRequired(this)) {
                UIUtilities.showToast(this, R.string.sync_required);
            } else {
        ...
        } else if (i1 == R.id.restore) {// Check to ensure there's a file to restore
        ...
        } else if (i1 == R.id.backup) {// If there's already a backup file prompt the user if they want to overwrite
        ...
        } else if (i1 == R.id.about) {
            showDialog(DIALOG_ABOUT);

        } else if (i1 == R.id.sync) {
        ...
        } else if (i1 == R.id.preferences) {
            startActivity(new Intent(this, Prefs.class));

        } else if (i1 == R.id.delete_db) {
            showDialog(CONFIRM_DELETE_DB_DIALOG);

        } else if (i1 == R.id.import_certificate) {
            showDialog(IMPORT_CERT_DIALOG);

        } else if (i1 == R.id.delete_certificate) {
            deleteCertificate();

        } else if (i1 == R.id.donate) {
            launchDonatePage();
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        case IMPORT_CERT_DIALOG:
            ...
            dialogBuilder
                ...
                .setPositiveButton(R.string.import_cert, new OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        importCert();
                    }
                })
